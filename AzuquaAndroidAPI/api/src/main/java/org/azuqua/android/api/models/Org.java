...
public class Org {
    ...
    public Org(long id, String name, String display_name, String namespace, String trail_start, String trail_end, boolean trail_used, boolean active, boolean enabled, String role_type, boolean selected) {
        this.id = id;
        this.name = name;
